...
//获取name对应的值，return值的个数
int getenv_r (char *name, char *buf, unsigned len)
{
	//name = bootargs
	int i, nxt;
	//获取字符串的每个字符
	//static uchar env_get_char_init (int index) 获取字符env_get_char是env_get_char_init
	//{的指针
	//	uchar c;
	...
	//	} else {
	//		c = default_environment[index]; //"bootargs=" CONFIG_BOOTARGS "\0"
	//	}
	...
	for (i=0; env_get_char(i) != '\0'; i=nxt+1) {
		...
		//envmatch (uchar *s1, int i2) s1 = bootargs
		//{
